package istic.fr.star2bb.contract;

import android.net.Uri;
import android.provider.BaseColumns;

/**
 * Created by Bah on 31/12/2017.
 */
...
public interface  StarContract {
    ...
    interface BusRoutes {
        ...
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderBB.busroute";
    ...
    interface Trips {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderBB.trip";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.starproviderBB.trip";
    ...
    interface Stops {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderBB.stop";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.starproviderBB.stop";
    ...
    interface StopTimes {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderBB.stoptime";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.starproviderBB.stoptime";
    ...
    interface Calendar {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderBB.calendar";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.starproviderBB.calendar";
